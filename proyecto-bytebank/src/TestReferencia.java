public class TestReferencia {
    ...
    public static void main(String[] args) {
        ...
        segundaCuenta.saldo = 50 ; // ATENCION, asignarle al campo saldo el valor 50 afecta al objeto primeraCuenta? SI
            // Este Output es = 50.0 y 50.0 ;
        System.out.println("Saldo en primera cuenta es : "+primeraCuenta.saldo);
        System.out.println("Saldo en segunda cuenta es : "+segundaCuenta.saldo);
